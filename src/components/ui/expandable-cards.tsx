        ...
        <div className="w-full max-w-7xl mx-auto px-4 min-h-[500px] flex flex-col lg:flex-row gap-4">
            {items.map((item) => (
                ...
                >
                    ...
                    {/* Overlay Gradient */}
                    <div className={cn(
                        "absolute inset-0 bg-black/40 transition-colors duration-300",
                        activeId === item.id ? "bg-black/20" : "bg-black/60 group-hover:bg-black/40"
                    )} />
                    ...
                    <div className="absolute inset-0 p-6 flex flex-col justify-end">
                        ...
                        {activeId !== item.id && (
                            <div className="hidden lg:flex items-center justify-center w-full h-full">
                                <h3 className="text-xl font-bold text-white/70 -rotate-90 whitespace-nowrap tracking-widest origin-center">
                                    {item.title}
                                </h3>
                            </div>
                        )}
                            ...
                            {activeId === item.id && (
                                ...
                                >
                                    <div className="flex justify-between items-start gap-4">
                                        ...
                                        <a
                                            href={item.href}
                                            className="bg-white text-black p-3 rounded-full hover:bg-white/80 transition-colors shrink-0"
                                        >
