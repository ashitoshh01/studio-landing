                        ...
                        >
                            <div className="flex justify-end">
                                <Button
                                    variant="ghost"
                                    size="icon"
                                    className="text-white hover:bg-white/10 hover:rotate-90 transition-transform duration-200"
                                    onClick={() => setOpen(false)}
                                >
                                    <X className="h-6 w-6" />
                                </Button>
                                ...
                                {tabs.map((tab, index) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className="flex items-center gap-4 p-3 text-lg font-medium text-white/70 hover:text-white hover:bg-white/5 rounded-lg transition-all"
                                        >
